    ...
    <footer className="bg-school-blue-dark text-white">
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold font-heading">Evergreen Academy</span>
            </div>
            <p className="text-gray-300 mb-4">
              Nurturing minds and building futures since 1970, with a commitment to academic excellence
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#programs" className="text-gray-300 hover:text-white transition-colors">Academic Programs</a></li>
              <li><a href="#faculty" className="text-gray-300 hover:text-white transition-colors">Our Faculty</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Policies & Handbooks</a></li>
            </ul>
          </div>
          
          <div>
            <h3 className="text-lg font-semibold mb-4 font-heading">Newsletter</h3>
            <p className="text-gray-300 mb-4">
            ...
            <form className="flex space-x-1">
              <input
                ...
                className="flex-1 px-3 py-2 text-sm bg-white/10 border border-gray-600 rounded-l-md focus:outline-none focus:ring-1 focus:ring-school-purple-light text-white"
              />
              <button
                type="submit"
                className="px-3 py-2 text-sm font-medium bg-school-purple hover:bg-school-purple-light text-white rounded-r-md"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700 text-center text-gray-300 text-sm">
          <p>© {new Date().getFullYear()} Evergreen Academy. All rights reserved.</p>
